            ...
            <div class="col-12">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo url('actions/user/update') ?>" class="needs-validation row" novalidate="" method="POST">
                            ...
                            <div class="form-group col-md-6">
                                <label>NISN</label>
                                <input type="text" class="form-control " name="nisn" value="<?php echo $student['nisn'] ?>" disabled>
                            ...
                            <div class="form-group col-md-6">
                                <label>NIS</label>
                                <input type="text" class="form-control " name="nis" value="<?php echo $student['nis'] ?>" disabled>
                                <div class="invalid-feedback">
                                    Silahkan isi NIS.
                                </div>
                            </div>
